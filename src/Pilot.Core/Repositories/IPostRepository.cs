...
public interface IPostRepository
{
    ...
    Task<(IReadOnlyList<Post> Items, int Total)> GetPaginatedByCampaignIdAsync(string campaignId, int page, int pageSize, string? status = null, string? search = null, CancellationToken cancellationToken = default);
    Task<(IReadOnlyList<Post> Items, int Total)> GetPaginatedByUserIdAsync(string userId, int page, int pageSize, string? status = null, string? search = null, CancellationToken cancellationToken = default);
